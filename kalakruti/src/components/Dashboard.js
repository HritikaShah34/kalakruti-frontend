...
import image1 from '../resources/logo.jpg';
...
const initialNavigation = [
  ...
  { name: 'Get all Products', href: '/getProducts', current: false },
...
export default function Dashboard() {
  ...
  const handleNavigationClick = (event, clickedIndex) => {
...
{/* 
        ...
        <main>
          <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            {navigation[0].current && <Stats/>}
            {navigation[1].current && <Add_Product />}
            {navigation[2].current && <Update_product />}
            {navigation[3].current && <Billing />}
          </div>
        </main>
      </div>
    </>
